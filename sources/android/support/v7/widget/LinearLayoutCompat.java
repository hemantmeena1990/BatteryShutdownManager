...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (childBaseline != -1) {
            ...
            if (this.mOrientation == 1 && (majorGravity = this.mGravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED) != 48) {
                switch (majorGravity) {
                    case 16:
        ...
        while (i3 < count) {
            ...
            if (child == null) {
                ...
                if (baselineAligned && (childBaseline2 = child.getBaseline()) != -1) {
                    ...
                    int index = (((i2 & Constants.BILLING_ERROR_SKUDETAILS_FAILED) >> 4) & -2) >> 1;
            ...
            for (int i5 = 0; i5 < count; i5++) {
                ...
                if (!(child3 == null || child3.getVisibility() == 8)) {
                    ...
                    if (baselineAligned && (childBaseline = child3.getBaseline()) != -1) {
                        ...
                        int index2 = (((i & Constants.BILLING_ERROR_SKUDETAILS_FAILED) >> 4) & -2) >> 1;
    ...
    public void layoutVertical(int left, int top, int right, int bottom) {
        ...
        int count = getVirtualChildCount();
        int majorGravity = this.mGravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED;
    ...
    public void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        int minorGravity = this.mGravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED;
        boolean baselineAligned = this.mBaselineAligned;
        int[] maxAscent = this.mMaxAscent;
        int[] maxDescent = this.mMaxDescent;
        ...
        while (i < count) {
            ...
            if (child == null) {
                ...
                switch (gravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED) {
                    case 16:
    ...
    public void setGravity(int gravity) {
        if (this.mGravity != gravity) {
            ...
            if ((gravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED) == 0) {
                gravity |= 48;
            }
    ...
    public void setVerticalGravity(int verticalGravity) {
        int gravity = verticalGravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED;
        if ((this.mGravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED) != gravity) {
