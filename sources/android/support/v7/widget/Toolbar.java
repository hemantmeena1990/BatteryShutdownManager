...
public class Toolbar extends ViewGroup {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            lp.gravity = 8388613 | (this.mButtonGravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = 8388611 | (this.mButtonGravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED);
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (layoutTitle || layoutSubtitle) {
            ...
            switch (this.mGravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED) {
                case 48:
    ...
    private int getChildVerticalGravity(int gravity) {
        int vgrav = gravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED;
        switch (vgrav) {
            case 16:
            case 48:
            case 80:
                return vgrav;
            default:
                return this.mGravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED;
        }
    }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (Toolbar.this.mExpandedActionView.getParent() != Toolbar.this) {
                ...
                lp.gravity = 8388611 | (Toolbar.this.mButtonGravity & Constants.BILLING_ERROR_SKUDETAILS_FAILED);
                lp.mViewType = 2;
