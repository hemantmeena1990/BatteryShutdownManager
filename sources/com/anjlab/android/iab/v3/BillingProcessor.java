...
public class BillingProcessor extends BillingBase {
    ...
    public BillingProcessor(Context context, String licenseKey, String merchantId, IBillingHandler handler) {
        ...
        this.serviceConnection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                IInAppBillingService unused = BillingProcessor.this.billingService = IInAppBillingService.Stub.asInterface(service);
    ...
    private boolean loadPurchasesByType(String type, BillingCache cacheStorage) {
        ...
        try {
            Bundle bundle = this.billingService.getPurchases(3, this.contextPackageName, type, (String) null);
                ...
                if (purchaseList != null) {
                    ...
                    while (i < purchaseList.size()) {
                        ...
                        if (!TextUtils.isEmpty(jsonData)) {
                            cacheStorage.put(new JSONObject(jsonData).getString(Constants.RESPONSE_PRODUCT_ID), jsonData, (signatureList == null || signatureList.size() <= i) ? null : signatureList.get(i));
                        }
                        i++;
                    }
                }
            ...
            if (bundle != null) {
                ...
                if (response == 0) {
                    ...
                    if (!checkMerchant(details)) {
                        ...
                        if (this.eventHandler != null) {
                            this.eventHandler.onBillingError(104, (Throwable) null);
                        }
                        return false;
                    } else if (this.eventHandler != null) {
                        if (details == null) {
    ...
    public boolean consumePurchase(String productId) {
        ...
        try {
            ...
            if (this.eventHandler != null) {
                this.eventHandler.onBillingError(response, (Throwable) null);
            }
            ...
            this.eventHandler.onBillingError(Constants.BILLING_ERROR_CONSUME_FAILED, e);
            return false;
        }
    }
            ...
            try {
                ...
                if (response == 0) {
                    ...
                    for (String responseLine : detailsList) {
                        productDetails.add(new SkuDetails(new JSONObject(responseLine)));
                    }
                    return productDetails;
                }
                if (this.eventHandler != null) {
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == -1 && responseCode == 0 && !TextUtils.isEmpty(purchasePayload)) {
            ...
            this.eventHandler.onBillingError(responseCode, (Throwable) null);
        }
        return true;
    }
